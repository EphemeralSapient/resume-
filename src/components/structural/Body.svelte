		...
		},
		{
			...
			details: [
				...
				},
				{
					...
					link: 'DSA using Java',
					description:
						'An online course of 70+ hours of Data Structures and Algorithms using Java.',
				},
			],
		},
	];
			...
			details: [
				{
					...
					dates: '2021—2025',
					description: 'CGPA: 8.3 [until 5th semester]',
					location: 'Kalapatti',
				},
				{title:" ",subtitle:" "},
				{
			...
			details: [
				{
					...
					subtitle: '',
					dates: 'Github',
					description: 'It is a comprehensive and scalable class management application made using flutter and firebase.',
					list: [
						"Smart attendance system using face recognition",
						"Instant announcement and notification features",
						"Track student's performance and attendance",
